        ...
        onSubmit: async values => {
            ...
            try {
                ...
                const response = await axios.post(REGISTER_USER_URL,
                    JSON.stringify({ username: values.username, email: values.email, password: values.password,role:role }),
                    {
        ...
        <>
            {success ? (
                <section>
                    ...
                    <p>
                        <a href="/loginuser">
                            <h1 className=" font-poppins cursor-pointer text-[30px] text-white text-gradient">Login</h1>
                        </a>
                    </p>
                </section>
            ) : (
                ...
                <div className='bg-primary w-full'>
                    ...
                    <div className="bg-primary w-full flex flex-col items-center min-h-screen pt-6 sm:justify-center sm:pt-0">
                        <div>
                            <a href="/">
                                <h1 className=" font-poppins cursor-pointer text-[30px] text-white text-gradient">Signup</h1>
                            </a>
                        </div>
